...
##### 1.	Infrastructure as Code (Terraform)
  * rovision a VPC with public and private subnets (if needed)
...
This part contains the sample code for the two microservices you'll be working with during the hackathon: Patient Service and Appointment Service.
